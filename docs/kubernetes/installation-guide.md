...
> [!WARNING]
> **Namespace-restricted mode** (`namespaceRestriction.enabled=true`) is only for development and testing. It is not supported for production. Use the default cluster-wide mode for production deployments.
